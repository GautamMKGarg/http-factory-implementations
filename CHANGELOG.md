...
-   Correct typo in `Http\Factory\Guzzle\ResponseFactory` reference — [\@stephenfrank](https://github.com/stephenfrank) ([\#1](https://github.com/psr-discovery/http-factory-implementations/pull/1))
